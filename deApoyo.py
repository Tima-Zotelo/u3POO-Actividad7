...
class deApoyo (Personal):
    ...
    def __str__(self) -> str:
        s = f'Cuil: {super().getCuil()}, apellido {super().getApellido()}, nombre: {super().getNombre()}, sueldo Basico: {super().getSueloBasico()}, antiguedad: {super().getAntiguedad()}, categoria: {self.__categoria}'
        return s
