...
class Investigador (Personal):
    ...
    def __str__(self) -> str:
        s = f'Cuil: {super().getCuil()}, apellido {super().getApellido()}, nombre: {super().getNombre()}, sueldo Basico: {super().getSueloBasico()}, antiguedad: {super().getAntiguedad()}, area de investigacion: {self.__areaInvest}, tipo de investigacion: {self.__tipoInvest}'
        return s
